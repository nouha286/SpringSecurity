...
public class ProviderService {
    ...
    public void addProvider(Provider provider)
    {
        ...
        if (provider.getAddress()==null || provider.getEmail()==null || provider.getPassword()==null  || provider.getPhone()==null ||  provider.getName()==null )
        {
    ...
    public Provider updateProvider(Provider provider)
    {
        ...
        if (provider.getName()!=null) providerUpdated.setName(provider.getName());
